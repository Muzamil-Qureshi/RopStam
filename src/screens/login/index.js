import { View, Text, TextInput, ScrollView, TouchableOpacity, Image, KeyboardAvoidingViewBase } from 'react-native'
    ...
    return (
        <SafeAreaView style={styles.container}>
            <KeyboardAwareScrollView style={{ padding: 16 }}>
                ...
                <PrimaryTextInput value={userName} placeholder='User Name' onchangetext={e => setuserName(e)} />
                ...
                />
                <PrimaryButton loader={loaderShow} onPress={() => loginFunction()} btnStyle={{ marginTop: hp(2) }} btnTitle={'Login'} />
